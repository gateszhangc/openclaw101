...
description: "把 Provider、Model、Auth 三件事拆开，第一次就走一条稳的默认模型路线。"
episode: 3
roleName: "虾滑"
...
<Callout title="虾滑的话" tone="tip">
  <p><code>Channel</code> 决定你从哪说话。</p>
  <p><code>Provider</code> 决定谁来思考。</p>
  <p>这两个一旦混了，排错会特别痛苦。</p>
</Callout>
...
<Callout title="虾滑提醒" tone="warning">
  <p>新手最容易把“页面能打开”误判成“系统已经配置好”。</p>
  <p>实际上，UI 能打开，只说明前门开了。</p>
  <p>能不能思考，要看后面的 Provider 和 Auth。</p>
</Callout>
